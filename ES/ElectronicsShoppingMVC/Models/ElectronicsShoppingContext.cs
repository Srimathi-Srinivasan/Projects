...
namespace ElectronicsShoppingMVC.Models
{
    public partial class ElectronicsShoppingContext : DbContext
    {
        ...
        public virtual DbSet<TelevisionCategory> TelevisionCategories { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Television>(entity =>
            {
                ...
                entity.HasOne(d => d.Category)
                    ...
                    .HasConstraintName("FK__Televisio__Categ__3D5E1FD2");
            });

            modelBuilder.Entity<TelevisionCategory>(entity =>
            {
                entity.HasKey(e => e.CategoryId)
                    .HasName("PK__Televisi__19093A2B0DF26824");

                entity.ToTable("TelevisionCategory");
